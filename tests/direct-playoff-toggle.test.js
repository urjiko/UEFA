...
const expectedRemovable = Object.freeze({ ucl: 0, uel: 12, uecl: 36 });
...
console.log('All 48 unresolved playoff slots support direct reserve-search insertion and repeated two-way reload-backed switching.');
