...
assert.match(config, /prediction-community-v3\.js\?v=20260905e/);
...
console.log('Community results are event-driven, non-recursive, and Finish remains single-owner.');
