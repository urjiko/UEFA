...
assert.match(resultsCss, /body\[data-league="uecl"\].*#58c4d6/);
...
console.log('Community results use sharp vertical charts, bounded crests and an event-driven Finish flow.');
