...
assert.match(html, /<script src="ui-refinement-v4\.js(?:\?v=[^"]+)?"><\/script>/);
...
assert.match(ui5, /prediction-share-v8\.js(?:\?v=20260828p1)?/);
assert.match(ui5, /onlyPredictionMutations/);
assert.doesNotMatch(ui5, /addEventListener\('scroll', queueRefresh/);
